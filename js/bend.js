/* Bend scroll engine from canvas-ui (DavidHDev/canvas-ui). License: MIT + Commons Clause. */
var __BendBundle = (() => {
  ...
  // .tmp/BendVanilla.ts
  var BendVanilla_exports = {};
  __export(BendVanilla_exports, {
...
void main () {
  ...
  return __toCommonJS(BendVanilla_exports);
})();
window.AICreativeLabBend = __BendBundle;
